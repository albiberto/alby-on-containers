...
namespace ProductDataManager.Infrastructure.Migrations
{
    ...
    [Migration("20240510160315_AddAttr")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductDataManager.Domain.Aggregates.AttributeAggregate.AttributeCluster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProductDataManager.Domain.Aggregates.AttributeAggregate.AttributeType", b =>
                {
                    b.HasOne("ProductDataManager.Domain.Aggregates.AttributeAggregate.AttributeCluster", "Cluster")
                        .WithMany("Types")
